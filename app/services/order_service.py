...
class OrderService:
    ...
    def update_order(self, request_id: str, order_update: OrderUpdate):
        order = self._order_dao.get_order(request_id)
        ...
        return self._order_dao.update_order(request_id, order)
